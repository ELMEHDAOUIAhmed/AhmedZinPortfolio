export const translations = {
  ...
  fr: {
    ...
    hero: {
      ...
      chips: ['Ingénieur Logiciel', 'Développeur Mobile & Full-Stack', 'Projets IoT', 'Étudiant Master'],
      ...
      experiences: [
        {
          ...
          company: 'Hb Technologies SPA',
          timeline: '11/2024 - 07/2025',
          description: 'Conception et développement d\'une solution pour le permis de conduire numérique, conforme à la norme ISO 18013-5, utilisant une architecture microservices. Le backend, développé en GoLang, tandis que l\'interface mobile, construite avec Flutter. La solution inclut une reconnaissance faciale basée sur Python.',
          technologies: ['GoLang', 'Flutter', 'Python', 'PKI', 'ISO 18013-5', 'Microservices'],
        },
        {
          id: '2',
        ...
        },
        {
          ...
          company: 'Projet Universitaire USTHB',
          timeline: '04/2022 – 05/2022',
          description: 'Développement d\'un logiciel en 5 jours avec un outil Rad Window pour le frontend et le backend, en appliquant des méthodes Agile.',
          technologies: ['RAD Window', 'Agile', 'Gestion Base de Données'],
        },
        {
          id: '4',
          ...
          company: 'Micro Club - USTHB',
          timeline: '05/2022',
          description: 'Développement d\'un projet universitaire avec HTML, CSS, JavaScript et PHP pour gérer une base de données d\'étudiants, incluant un système d\'inscriptions avec vérification email.',
          technologies: ['HTML', 'CSS', 'JavaScript', 'PHP', 'MySQL'],
        },
        {
          id: '5',
          ...
          company: 'Projet Universitaire USTHB',
          timeline: '04/2022 – 05/2022',
          description: 'Développement d\'un logiciel en JavaFX avec base de données SQL pour gérer l\'inventaire, les bons de commande et les opérations de production.',
